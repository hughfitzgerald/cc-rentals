      ...
      <Text>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              the Website as the legal entity that collects Consumers' personal
          ...
          <li>
            <p>
              ...
              person who processes the data on behalf of the Website. It refers
              to third-party companies or individuals employed by the Website to
              facilitate the Service, to provide the Service on behalf of the
              Website, to perform services related to the Service or to assist
              the Website in analyzing how the Service is used.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Culver City Rental Registry,
              accessible from{" "}
              <a
                href="https://www.ccrentals.org"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.ccrentals.org
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            that permit the Website, for example, to count users who have
        ...
        <ul>
          <li>
            ...
            information with Service Providers listed below to to contact You or
        ...
        <p>
          Please note, however, that We may retain certain information when we
        ...
        <ul>
          ...
          <li>
            As required by applicable law, court order, or governmental
            regulations.
          </li>
          <li>
        ...
        <p>
          ...
          for activities such as analytics, and these may be deemed a aale under
          CCPA/CPRA.
        </p>
        <p>
        ...
        <ul>
          <li>
            By email: <a href="mailto:info@ccrentals.org">info@ccrentals.org</a>
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          understood. We do allow Service Providers to use Your personal
          information for the business purposes described in Our Privacy Policy,
          for activities such as analytics, and these may be deemed a sale under
          CCPA/CPRA.
        </p>
        <p>
